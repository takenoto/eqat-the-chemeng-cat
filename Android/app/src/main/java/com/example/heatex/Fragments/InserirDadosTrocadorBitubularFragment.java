...
public class InserirDadosTrocadorBitubularFragment extends Fragment {
    ...
    private Handler temporal = new Handler();
    ...
    LinearLayout diametrosOcultarLinearLayout, bitubularPadraoProjetoLinearLayout, demaisTrocsPadraoProjetoLinearLayout, cascoETubosLinearLayout;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle SavedInstance){
        ...
        final View rootView = inflater.inflate(R.layout.fragment_trocador_bitubular_usar_na_tabbed, container, false);
            ...
            temporal.postDelayed(carregoso, 10);
    ...
    public void carregarTela(){
        //Aí carrega tudo só aqui pra não ficar lesando!
        //super.onStart();
        ...
        //casco e tubos
        cascoETubosLinearLayout = rootView.findViewById(R.id.cascoETubosLinearLayout);
        RecyclerView cascoETubosRecyclerView = rootView.findViewById(R.id.cascoETubosRecyclerView);
        RadioButton cascoSquare90 = rootView.findViewById(R.id.squareLayoutRadioButton);
        RadioButton cascoTriang60 = rootView.findViewById(R.id.triangularLayoutRadioButton);
        ...
        //CASCO E TUBOS - RECYCLER VIEW
        List<PropriedadeBasica> listaCasco = new ArrayList<>();
        //Essa última informação diz onde que o valor deve ser aplicado, só pra saber do que se trata
        //PropriedadeBasica miniProp = new PropriedadeBasica(sigla, texto, unidade, idSiglas[i]);
        PropriedadeBasica miniProp = new PropriedadeBasica(getResources().getString(R.string.pitch_sigla), getResources().getString(R.string.pitch_texto), getResources().getString(R.string.pr_unidade_si), R.string.pitch_sigla);
        listaCasco.add(miniProp);
        miniProp = new PropriedadeBasica(getResources().getString(R.string.baffle_sigla), getResources().getString(R.string.baffle_b_texto), getResources().getString(R.string.comprimento_maximo_unidade_si), R.string.baffle_sigla);
        listaCasco.add(miniProp);
        propriedadesBasicasTrocAdapter adapterCasco = new propriedadesBasicasTrocAdapter(getContext(),listaCasco, tipo, 0);
        RecyclerView.LayoutManager layoutManagerCasco = new LinearLayoutManager(rootView.getContext());
        mudancaFaseInternoRecyclerView.setLayoutManager(layoutManagerCasco);
        mudancaFaseInternoRecyclerView.setHasFixedSize(true);
        mudancaFaseInternoRecyclerView.addItemDecoration(new DividerItemDecoration(rootView.getContext(), LinearLayout.VERTICAL));
        cascoETubosRecyclerView.setAdapter(adapterCasco);
        ...
        carregarSpinnerPadraoProjeto();//pra carregar logo por via das dúvidas
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId){
                    case R.id.trocadorBitubularRadioButton:{
                        ...
                        cascoETubosLinearLayout.setVisibility(View.GONE);
                    ...
                    case R.id.trocadorCascoETubosRadioButton:{
                        ...
                        cascoETubosLinearLayout.setVisibility(View.VISIBLE);
                        break;
                    }
                }
            }
