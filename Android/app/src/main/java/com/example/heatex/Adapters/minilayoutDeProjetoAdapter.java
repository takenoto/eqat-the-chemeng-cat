    ...
    public void onBindViewHolder(final MyViewHolder holder, int i) {
        ...
        switch (tipoDeProjeto){
            case ProjetoDeBase.TROCADOR_DE_CALOR:
                ...
                //Descobre qual trocador que é
                int tipoDeTrocador = projeto.obterProjetoTrocador().getIdDoTipoDeTrocador();
                if(tipoDeTrocador==TrocadorBitubularHeatex.BITUBULAR){idDaString = R.string.trocador_bitubular; idDaImagem = R.drawable.ic_troc_bitubular_holo_light;}
                else if(tipoDeTrocador==TrocadorBitubularHeatex.MULTITUBULAR){idDaString = R.string.trocador_de_calor_multitubular_hairpin; idDaImagem = R.drawable.ic_troc_multitubular_holo_light;}
                else{idDaString = R.string.trocador_casco_e_tubos; idDaImagem = R.drawable.ic_troc_casco_e_tubos_holo_light;}
